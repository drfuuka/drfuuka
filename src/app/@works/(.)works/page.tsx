        ...
        <div className="px-6 py-10 md:px-32 md:py-16 lg:px-64 lg:py-20">
          ...
          <div className="my-10 px-40 ">
            ...
            <p>
              ...
              components, Extej streamlines development, reduces costs, and
              ensures an exceptional user experience.
            </p>

            <div className="my-3"></div>

            <p>
              You can also buy this template. You can check the website demo
              from the link below
            </p>
